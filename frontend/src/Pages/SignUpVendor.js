        ...
        <div className="row ms-3 d-flex flex-row ">
          <div className="col-6 ">
            ...
            <div className="col-10 form_div">
              ...
              <label> <input type="radio" className='radio_button' value="question" name='radio'   />  Independent Entity</label>
              <label> <input type="radio" className='radio_button' value="question" name='radio' />  Business Owner</label>
            </div>
